...
Route::get('/digitalhealthmilestone',[App\Http\Controllers\DigitalhealthmilestoneController::class, 'show_data'])->name('digitalhealthmilstone');
Route::get('/digitalmatrix',[App\Http\Controllers\DigitalmatrixController::class, 'show_data'])->name('digitalmatrx');
Route::get('/activites/{id}', [App\Http\Controllers\HomeController::class, 'view_details'])->name('activity_details');
...
Route::get('menusubcategory/{id}', [App\Http\Controllers\MenuSubCategoryController::class, 'show'])->name('menusubcategory.show');
...
Route::post('digitalhealthmilstone', [App\Http\Controllers\DigitalhealthmilestoneController::class, 'store'])->name('digitalhealthmilestone');
