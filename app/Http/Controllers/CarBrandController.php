...
class CarBrandController extends Controller
{
    ...
    public function index(){
        ...
        return  view('backend.carbrand.index',compact('data'));
    }

    public function create(){

        return  view('backend.carbrand.create');
    }
    ...
    public function show($id){
        ...
        return  view('backend.carbrand.show',compact('data'));
    }
    ...
    public function edit($id){
        ...
        return  view('backend.carbrand.edit',compact('data'));
    }
